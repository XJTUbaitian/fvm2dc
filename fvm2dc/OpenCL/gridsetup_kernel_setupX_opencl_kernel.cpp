...
static bool isbuilt_gridsetup_kernel_setupX = false;

void buildOpenCLKernels_gridsetup_kernel_setupX(int xdim0, int xdim1, int xdim2,
                                                int xdim3, int xdim4, int xdim5,
                                                int xdim6) {

  // int ocl_fma = OCL_FMA;
  if (!isbuilt_gridsetup_kernel_setupX) {
    buildOpenCLKernels();
    // clSafeCall( clUnloadCompiler() );
    cl_int ret;
    char *source_filename[1] = {(char *)"./OpenCL/gridsetup_kernel_setupX.cl"};
    ...
    printf("Compiling gridsetup_kernel_setupX %d source -- start \n", OCL_FMA);
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_gridsetup_kernel_setupX=%d  "
                           "-Dxdim1_gridsetup_kernel_setupX=%d  "
                           "-Dxdim2_gridsetup_kernel_setupX=%d  "
                           "-Dxdim3_gridsetup_kernel_setupX=%d  "
                           "-Dxdim4_gridsetup_kernel_setupX=%d  "
                           "-Dxdim5_gridsetup_kernel_setupX=%d  "
                           "-Dxdim6_gridsetup_kernel_setupX=%d ",
    ...
    printf("compiling gridsetup_kernel_setupX -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[0] = clCreateKernel(
        OPS_opencl_core.program, "ops_gridsetup_kernel_setupX", &ret);
    clSafeCall(ret);

    isbuilt_gridsetup_kernel_setupX = true;
  }
}
...
void ops_par_loop_gridsetup_kernel_setupX(char const *name, ops_block block,
  ...
  buildOpenCLKernels_gridsetup_kernel_setupX(xdim0, xdim1, xdim2, xdim3, xdim4,
                                             xdim5, xdim6);
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[0], 4, sizeof(cl_mem),
                            (void *)&arg4.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[0], 5, sizeof(cl_mem),
                            (void *)&arg5.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[0], 6, sizeof(cl_mem),
                            (void *)&arg6.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[0], 7, sizeof(cl_double),
                            (void *)&xmin));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[0], 8, sizeof(cl_double),
                            (void *)&xmax));
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[0], 12, sizeof(cl_int),
                            (void *)&xL3));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[0], 13, sizeof(cl_int),
                            (void *)&base0));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[0], 14, sizeof(cl_int),
                            (void *)&base1));
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[0], 21, sizeof(cl_int),
                            (void *)&arg_idx[1]));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[0], 22, sizeof(cl_int),
                            (void *)&x_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[0], 23, sizeof(cl_int),
                            (void *)&y_size));
