...
// user function
void gridsetup_kernel_celldy(__global double *restrict celldy,
                             __global double *restrict celly, int *restrict idx)
...
__kernel void ops_gridsetup_kernel_celldy(__global double *restrict arg0,
  ...
  if (idx_x < size0 && idx_y < size1) {
    gridsetup_kernel_celldy(
        &arg0[base0 + idx_x * 1 * 1 +
              idx_y * 1 * 1 * xdim0_gridsetup_kernel_celldy],
        &arg1[base1 + idx_x * 1 * 1 +
              idx_y * 1 * 1 * xdim1_gridsetup_kernel_celldy],
        arg_idx);
  }
}
