...
static bool isbuilt_gridsetup_kernel_setupY_Polar = false;

void buildOpenCLKernels_gridsetup_kernel_setupY_Polar(
    int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5, int xdim6,
    int xdim7, int xdim8, int xdim9, int xdim10) {

  // int ocl_fma = OCL_FMA;
  if (!isbuilt_gridsetup_kernel_setupY_Polar) {
    buildOpenCLKernels();
    // clSafeCall( clUnloadCompiler() );
    cl_int ret;
    char *source_filename[1] = {
        (char *)"./OpenCL/gridsetup_kernel_setupY_Polar.cl"};
    ...
    printf("Compiling gridsetup_kernel_setupY_Polar %d source -- start \n",
           OCL_FMA);
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_gridsetup_kernel_setupY_Polar=%d  "
                           "-Dxdim1_gridsetup_kernel_setupY_Polar=%d  "
                           "-Dxdim2_gridsetup_kernel_setupY_Polar=%d  "
                           "-Dxdim3_gridsetup_kernel_setupY_Polar=%d  "
                           "-Dxdim4_gridsetup_kernel_setupY_Polar=%d  "
                           "-Dxdim5_gridsetup_kernel_setupY_Polar=%d  "
                           "-Dxdim6_gridsetup_kernel_setupY_Polar=%d  "
                           "-Dxdim7_gridsetup_kernel_setupY_Polar=%d  "
                           "-Dxdim8_gridsetup_kernel_setupY_Polar=%d  "
                           "-Dxdim9_gridsetup_kernel_setupY_Polar=%d  "
                           "-Dxdim10_gridsetup_kernel_setupY_Polar=%d ",
    ...
    printf("compiling gridsetup_kernel_setupY_Polar -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[4] = clCreateKernel(
        OPS_opencl_core.program, "ops_gridsetup_kernel_setupY_Polar", &ret);
    clSafeCall(ret);

    isbuilt_gridsetup_kernel_setupY_Polar = true;
  }
}

// host stub function
void ops_par_loop_gridsetup_kernel_setupY_Polar(
  ...
  if (OPS_diags > 1) {
    ops_timing_realloc(4, "gridsetup_kernel_setupY_Polar");
    OPS_kernels[4].count++;
  ...
  buildOpenCLKernels_gridsetup_kernel_setupY_Polar(xdim0, xdim1, xdim2, xdim3,
                                                   xdim4, xdim5, xdim6, xdim7,
                                                   xdim8, xdim9, xdim10);
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 0, sizeof(cl_mem),
                            (void *)&arg0.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 1, sizeof(cl_mem),
                            (void *)&arg1.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 2, sizeof(cl_mem),
                            (void *)&arg2.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 3, sizeof(cl_mem),
                            (void *)&arg3.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 4, sizeof(cl_mem),
                            (void *)&arg4.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 5, sizeof(cl_mem),
                            (void *)&arg5.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 6, sizeof(cl_mem),
                            (void *)&arg6.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 7, sizeof(cl_mem),
                            (void *)&arg7.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 8, sizeof(cl_mem),
                            (void *)&arg8.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 9, sizeof(cl_mem),
                            (void *)&arg9.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 10, sizeof(cl_mem),
                            (void *)&arg10.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 11, sizeof(cl_double),
                            (void *)&ymin));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 12, sizeof(cl_double),
                            (void *)&ymax));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 13, sizeof(cl_int),
                            (void *)&ycells));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 14, sizeof(cl_int),
                            (void *)&yM1));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 15, sizeof(cl_int),
                            (void *)&yM2));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 16, sizeof(cl_int),
                            (void *)&yM3));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 17, sizeof(cl_int),
                            (void *)&base0));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 18, sizeof(cl_int),
                            (void *)&base1));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 19, sizeof(cl_int),
                            (void *)&base2));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 20, sizeof(cl_int),
                            (void *)&base3));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 21, sizeof(cl_int),
                            (void *)&base4));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 22, sizeof(cl_int),
                            (void *)&base5));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 23, sizeof(cl_int),
                            (void *)&base6));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 24, sizeof(cl_int),
                            (void *)&base7));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 25, sizeof(cl_int),
                            (void *)&base8));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 26, sizeof(cl_int),
                            (void *)&base9));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 27, sizeof(cl_int),
                            (void *)&base10));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 28, sizeof(cl_int),
                            (void *)&arg_idx[0]));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 29, sizeof(cl_int),
                            (void *)&arg_idx[1]));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 30, sizeof(cl_int),
                            (void *)&x_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 31, sizeof(cl_int),
                            (void *)&y_size));
