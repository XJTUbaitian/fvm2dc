...
//
__constant__ int xdim0_gridsetup_kernel_celldy;
int xdim0_gridsetup_kernel_celldy_h = -1;
int ydim0_gridsetup_kernel_celldy_h = -1;
__constant__ int xdim1_gridsetup_kernel_celldy;
int xdim1_gridsetup_kernel_celldy_h = -1;
int ydim1_gridsetup_kernel_celldy_h = -1;
...
__device__
    ...
    void
    gridsetup_kernel_celldy(double *celldy, double *celly, int *idx) {
...
__global__ void ops_gridsetup_kernel_celldy(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_gridsetup_kernel_celldy;
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_gridsetup_kernel_celldy;

  if (idx_x < size0 && idx_y < size1) {
    gridsetup_kernel_celldy(arg0, arg1, arg_idx);
  }
}
...
void ops_par_loop_gridsetup_kernel_celldy(char const *name, ops_block block,
  ...
  if (xdim0 != xdim0_gridsetup_kernel_celldy_h ||
    ...
    cudaMemcpyToSymbol(xdim0_gridsetup_kernel_celldy, &xdim0, sizeof(int));
    xdim0_gridsetup_kernel_celldy_h = xdim0;
    cudaMemcpyToSymbol(xdim1_gridsetup_kernel_celldy, &xdim1, sizeof(int));
  ...
  ops_gridsetup_kernel_celldy<<<grid, tblock>>>((double *)p_a[0],
