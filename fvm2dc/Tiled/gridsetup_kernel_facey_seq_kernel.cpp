...
// host stub function
void ops_par_loop_gridsetup_kernel_facey_execute(ops_kernel_descriptor *desc) {
  ...
  int xdim0_gridsetup_kernel_facey = args[0].dat->size[0];
...
void ops_par_loop_gridsetup_kernel_facey(char const *name, ops_block block,
  ...
  desc->args[1] = arg1;
  desc->function = ops_par_loop_gridsetup_kernel_facey_execute;
  if (OPS_diags > 1) {
