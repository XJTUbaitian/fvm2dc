...
// host stub function
void ops_par_loop_gridsetup_kernel_celldy_execute(ops_kernel_descriptor *desc) {
  ...
  double *__restrict__ celldy = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const double *__restrict__ celly = (double *)(args[1].data + base1);

  // initialize global variable with the dimension of dats
  int xdim0_gridsetup_kernel_celldy = args[0].dat->size[0];
  int xdim1_gridsetup_kernel_celldy = args[1].dat->size[0];
...
#pragma omp simd aligned(celldy, celly)
#else
#pragma simd
#endif
...
void ops_par_loop_gridsetup_kernel_celldy(char const *name, ops_block block,
  ...
  desc->args[2] = arg2;
  desc->function = ops_par_loop_gridsetup_kernel_celldy_execute;
  if (OPS_diags > 1) {
